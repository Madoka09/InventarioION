...
export class MultipleDeparturePage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,
    ...
    this.httpC.get("http://172.10.20.169/IonicApp/json_departure_checker.php").subscribe(data => {
      this.elements = data;
      this.element = [];
  ...
  getCurrentData(){
    this.httpC.get("http://172.10.20.169/IonicApp/json_read.php").subscribe(dataStock => {
  ...
  truncate() {
    this.httpC.get("http://172.10.20.169/IonicApp/json_table_clearer.php").subscribe(data => {
      this.elements = data;
      console.log(data);
    }, err => {
      console.log(err);
  ...
  sendItem(element) {
    ...
    loader.present().then(() => {
      this.http.post('http://172.10.20.169/IonicApp/json_departure_decrypter.php', data, options)
        .map(res => res.json())
        .subscribe(res => {
